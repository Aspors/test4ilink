...
// TODO это можно вынеси в отдельный файл, чтобы тут не болталось и не засоряло компонент 
const sliderItems = [
...
const SliderItem = () =>{
    ...
    // TODO вот сюда и вставь этот кусорк верстки, либо вынеси в отдельный компонент. Рендер функции - бэд практис
